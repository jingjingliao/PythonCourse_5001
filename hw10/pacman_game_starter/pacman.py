...
class Pacman(GameCharacter):
    ...
    def update(self):
        ...
        # when pacman's mouth angle is min_mouth_angle, the open_close should
        # continusly add mouth_speed until it reaches to max_mouth_angle, then
        # it should reduce until it reaches to min_mouth_angle again
        ...
        # execute eat_dots method in Maze class and put pacman's location as
        # parameters
